...
frontends = [
  ...
  },
  {
    ...
    enable_ssl     = true
    ssl_mode         = "AzureKeyVault"
    certificate_name = "staging-certificatedbailiffs-justice-gov-uk"
  },
  {
    ...
    enable_ssl     = true
    ssl_mode         = "AzureKeyVault"
    certificate_name = "staging-courtfines-direct-gov-uk"
  },
  {
    ...
    enable_ssl     = true
    ssl_mode         = "AzureKeyVault"
    certificate_name = "staging-immigrationappealsonline-justice-gov-uk"
  }
]
