...
frontends = [
      ...
      },
      {
        ...
        global_exclusions = [
          ...
          },
          {
            match_variable = "RequestCookieNames"
            operator       = "Equals"
            selector       = "thirdPartySubscriberCookie"
          },
          {
            match_variable = "RequestCookieNames"
            operator       = "Equals"
  ...
  {
    name           = "cath-web"
    custom_domain  = "cath-web.ithc.platform.hmcts.net"
    dns_zone_name  = "ithc.platform.hmcts.net"
    backend_domain = ["firewall-nonprodi-palo-sdsithc.uksouth.cloudapp.azure.com"]
  ...
  {
    name                = "cath-web-b2c-sign-in"
    custom_domain       = "sign-in.cath-web.ithc.platform.hmcts.net"
  ...
  },
  {
    ...
    custom_domain  = "opal-rm-frontend.ithc.apps.hmcts.net"
    dns_zone_name  = "ithc.apps.hmcts.net"
    backend_domain = ["firewall-nonprodi-palo-sdsithc.uksouth.cloudapp.azure.com"]
    cache_enabled  = "false"
    disabled_rules = {
  ...
  },
  {
    ...
    mode              = "Prevention"
    custom_domain     = "pdda-public-display-manager.ithc.platform.hmcts.net"
    dns_zone_name     = "ithc.platform.hmcts.net"
    backend_domain    = ["firewall-nonprodi-palo-sdsithc.uksouth.cloudapp.azure.com"]
    global_exclusions = []
    custom_rules = [
