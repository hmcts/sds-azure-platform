...
frontends = [
  {
    name           = "dts-legacy-apps-certificatedbailiffs-liv"
    mode           = "Detection"
  ...
  {
    name           = "dts-legacy-apps-civilappeals-casetracker-liv"
    mode           = "Detection"
  ...
  {
    name           = "dts-legacy-apps-courtfines-liv"
    mode           = "Detection"
  ...
  {
    name           = "dts-legacy-apps-immigration-appeals-iacfees-liv"
    mode           = "Detection"
  ...
  {
    name           = "dts-legacy-apps-utiac-liv"
    mode           = "Detection"
  ...
  {
    name           = "dts-legacy-apps-redirect-service-liv"
    mode           = "Detection"
